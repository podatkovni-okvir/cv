...
- change YAML in the .Rmd file [first 15 lines] (here you can also have fun exploring different templates from the `vitae` package (be careful of the code chunk at line 27 which alters highlight colors, might be best to delete it))
